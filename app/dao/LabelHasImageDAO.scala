...
@Singleton
class LevelDAO @Inject()(protected val dbConfigProvider: DatabaseConfigProvider)(implicit executionContext: ExecutionContext) extends LabelHasImageComponent with HasDatabaseConfigProvider[JdbcProfile] {
