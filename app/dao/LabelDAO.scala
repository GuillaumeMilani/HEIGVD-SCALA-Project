...
@Singleton
class LevelDAO @Inject()(protected val dbConfigProvider: DatabaseConfigProvider)(implicit executionContext: ExecutionContext) extends LabelComponent with HasDatabaseConfigProvider[JdbcProfile] {
